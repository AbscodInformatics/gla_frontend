...
import PastSpeakers from "../Events/PastEvents/PastSpeakers";

class SpeakersDubaiLegal extends React.Component {
  render() {
    const speakers = [
      {
    ...
    const cardData = [
      ...
      },
      {
        ...
        linkedIn:
          "https://www.linkedin.com/in/sergey-medvedev-phd-llm-63b3262a/",
      },
      {
        name: "Yosr Hamza",
    ...
    return (
      <React.Fragment>
        <MainBanner
          heading="Speakers - GLA  Litigation Dubai"
          lastLine="Speakers"
        />
        <NewSpeakers cardData={speakers} />
...
export default SpeakersDubaiLegal;
